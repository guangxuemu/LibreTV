// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["dyttzy","ruyi","hwba","ffzy","lzzy","bfzy","qiqikp","heimuer","mdzy","mozhua","wolong","tyyszy","ikunzy","zy360","wujin","zuida","dbzy","jisu","iqiyi","wwzy"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["dyttzy","ruyi","hwba","ffzy","lzzy","bfzy","qiqikp","heimuer","mdzy","mozhua","wolong","tyyszy","ikunzy","zy360","wujin","zuida","dbzy","jisu","iqiyi","wwzy"];
